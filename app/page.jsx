...
export default function Home() {
  ...
  return (
    <main className="w-full flex flex-col">
      ...
      <form className="w-full p-3 flex flex-col gap-2">
        <textarea
          value={text}
          onChange={handleChange}
          className="text-slate-300  h-32 p-4 border bg-slate-800 border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
